...
namespace utils {
  ...
  inline Rcpp::IntegerMatrix id_positions(
    ...
    Rcpp::StringVector unique_ids = geometries::utils::get_sexp_unique( line_ids );
  ...
  inline Rcpp::IntegerMatrix id_positions(
    ...
    Rcpp::IntegerVector unique_ids = geometries::utils::get_sexp_unique( line_ids );
    return id_positions( line_ids, unique_ids );
  }
  ...
  inline Rcpp::IntegerMatrix id_positions(
    ...
    Rcpp::NumericVector unique_ids = geometries::utils::get_sexp_unique( line_ids );
    return id_positions( line_ids, unique_ids );
  }
