...
- `geometries::shapes::get_mat()` - creates a matrix
- `geometries::shapes::get_listMat()` - creates lists of matrices
- `geometries::shapes::get_listListMat()` - creates lists of lists of matrices
